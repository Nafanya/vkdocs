package io.github.nafanya.vkdocs.presentation.ui.decorators;
 ...
 */
public class EndOffsetItemDecorator extends RecyclerView.ItemDecoration {
     ...
     */
    public EndOffsetItemDecorator(int offsetPx) {
        mOffsetPx = offsetPx;
    }
     ...
     *                       RecyclerView
     */
    public EndOffsetItemDecorator(Drawable offsetDrawable) {
